...
module.exports =  {
    ...
    async executePrefix(client, message, args) {
        if (message.author.id != "ownerID") return message.error("Bu komutu kullanmak için **yetkin** yok!");
        const clean = text => {
	...
	async executeSlash(interaction) {
        if (interaction.member.id != "ownerID") return interaction.error("Bu komutu kullanmak için **yetkin** yok!");
